...
export default function PropertiesPage() {
  ...
  const properties = demoProperties.filter(
    (p) =>
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              ${properties.reduce((sum, p) => sum + ((p.current_value || 0) - (p.mortgage_balance || 0)), 0).toLocaleString()}
            </div>
          </CardContent>
        </Card>
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              ${properties.reduce((sum, p) => sum + (p.mortgage_payment || 0), 0).toLocaleString()}
            </div>
          </CardContent>
        </Card>
      </div>
              ...
              <TableBody>
                {properties.map((property) => (
                  <TableRow key={property.id}>
                    ...
                    <TableCell className="text-right">
                      ${((property.current_value || 0) - (property.mortgage_balance || 0)).toLocaleString()}
                    </TableCell>
                    <TableCell>
                      <Badge
